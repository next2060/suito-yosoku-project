...
USER="next2060"
PASSWORDS=["GsWcFZq62025", "GsWcFZq62025"] #二つのうち、どちらかが正しければデータは取得できます
...
def set_credentials(username, password):
    ...
    外部から認証情報を設定するための関数
    """
    global USER, PASSWORDS
    USER = username
    # PASSWORDSはリスト形式なので、両方に同じパスワードを設定
    PASSWORDS = [password, password]
    print(f"AMD_Tools4: Credentials set for user '{username}'")
